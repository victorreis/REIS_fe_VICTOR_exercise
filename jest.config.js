...
module.exports = {
  ...
  collectCoverageFrom: tsconfig.include,
  ...
  setupFilesAfterEnv: ['<rootDir>/src/configs/tests/GlobalSetup.config.tsx'],
  ...
  testMatch: [
    '**/*/*__tests__/*.tsx', //! delete after refactor
    '**/*/__tests__/*.ts', //! delete after refactor
    '**/*/*.test.tsx',
    '**/*/*.test.ts',
  ],
